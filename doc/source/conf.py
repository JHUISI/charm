...
sys.path.insert(0, os.path.abspath('../..'))
sys.path.insert(0, os.path.abspath('../../schemes'))
sys.path.insert(0, os.path.abspath('../../schemes/abenc'))
sys.path.insert(0, os.path.abspath('../../schemes/dabenc'))
sys.path.insert(0, os.path.abspath('../../schemes/pkenc'))
sys.path.insert(0, os.path.abspath('../../schemes/pksig'))
sys.path.insert(0, os.path.abspath('../../schemes/ibenc'))
sys.path.insert(0, os.path.abspath('../../schemes/hibenc'))
sys.path.insert(0, os.path.abspath('../../schemes/grpsig'))
sys.path.insert(0, os.path.abspath('../../schemes/commit'))
...
copyright = '2012, Johns Hopkins University ISI'
