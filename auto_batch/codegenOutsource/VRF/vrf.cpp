...
void polyF(CharmList & sk, CharmListZR & u, list<int> & x, GT & result0)
{
    ZR ut;
    G1 g1;
    G2 h;
...
void prove(CharmList & sk, CharmListZR & u, list<int> & x, GT & y0, CharmListG1 & pi, G1 & pi0)
{
    ZR ut;
    G1 g1;
    G2 h;
...
bool verify(CharmListG1 & U1, CharmListG2 & U2, G2 & Ut, G1 & g1, G2 & g2, G2 & h, GT & y0, CharmListG1 & pi, G1 & pi0, list<int> & x)
{
