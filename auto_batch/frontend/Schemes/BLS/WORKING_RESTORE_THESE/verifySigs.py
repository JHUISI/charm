...
def verifySigsRecursive(verifyFuncArgs, argSigIndexMap, verifyArgsDict, dotA, dotB, pk_0, pk_1, startIndex, endIndex):
	...
	if pair ( dotA_runningProduct , pk_0 ) == pair ( dotB_runningProduct , pk_1 ):
		...
		verifySigsRecursive(verifyFuncArgs, argSigIndexMap, verifyArgsDict, dotA, dotB, pk_0, pk_1, startIndex, midIndex)
		verifySigsRecursive(verifyFuncArgs, argSigIndexMap, verifyArgsDict, dotA, dotB, pk_0, pk_1, midIndex, endIndex)
