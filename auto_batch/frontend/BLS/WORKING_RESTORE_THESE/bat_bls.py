...
if __name__ == '__main__':
	...
	verifySigsRecursive(verifyFuncArgs, argSigIndexMap, verifyArgsDict, dotA, dotB,  verifyArgsDict[argSigIndexMap['pk']]['pk'][bodyKey]['g^x'],  verifyArgsDict[argSigIndexMap['pk']]['pk'][bodyKey]['g'], 0, N)
