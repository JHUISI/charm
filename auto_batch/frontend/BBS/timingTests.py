...
from bat_bbs import run_Batch
from ind_bbs import run_Ind
...
if __name__ == '__main__':
	...
	validDictFile = deserialize( unpickleObject(validDictArg), groupParamArg )
	invalidDictFile = deserialize( unpickleObject(invalidDictArg), groupParamArg )
