...
def verifySigsRecursive(verifyArgsDict, groupObj, incorrectIndices, startSigNum, endSigNum, delta, dotC, dotA, dotB):
	z = 0
	...
	if (  pair( dotB_loopVal , verifyArgsDict[z]['mpk'][bodyKey] [ 'Pub' ] ) == pair( dotC_loopVal , verifyArgsDict[z]['mpk'][bodyKey] [ 'g' ] )   ):
		...
		verifySigsRecursive(verifyArgsDict, group, incorrectIndices, startSigNum, midSigNum, delta, dotC, dotA, dotB)
		verifySigsRecursive(verifyArgsDict, group, incorrectIndices, midSigNum, endSigNum, delta, dotC, dotA, dotB)
