...
if __name__ == '__main__':
	...
	for z in range(0, N):
		...
		a = H2( verifyArgsDict[argSigIndexMap['M']]['M'][bodyKey] , S1 )


		dotA[z] =  S2 ** deltaz[z] 

		dotB[z] =  verifyArgsDict[argSigIndexMap['pk']]['pk'][bodyKey] ** ( a * deltaz[z] ) 

		dotC[z] =  S1 ** deltaz[z] 


	verifySigsRecursive(verifyFuncArgs, argSigIndexMap, verifyArgsDict, dotA, dotB, dotC,  verifyArgsDict[argSigIndexMap['mpk']]['mpk'][bodyKey]['g2'],  verifyArgsDict[argSigIndexMap['mpk']]['mpk'][bodyKey]['P'], 0, N)
