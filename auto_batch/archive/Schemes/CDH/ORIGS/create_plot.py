...
x = 100
xx = 1000
files = { 'chp':40 }# , 'chp':30, 'chch':50, 'cyh':40, 'hess':50, 'bgls':120, 'boyen':150, 'waters':80 }
...
def build_graph( key, y_scale ):
    KEY = key.upper()
    indiv_name = "indOutputResults.dat"
    if meta[key]: indiv_key = meta[key]
    else: indiv_key = "individual"
    batch_name = "batchOutputResults.dat"
