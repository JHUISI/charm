...
class Boyen(PKSig):
    ...
    def setup(self):
        ...
        g1 = group.random(G1) 
        g2 = group.random(G2)
        a = [group.random(ZR) for i in range(l)]
        A = [] 
        At = []
        for i in range(l):
            A.append(g1 ** a[i])
...
if __name__ == "__main__":
   ...
   print("if we're here, we know individual verification works correctly")
   
   #start toy example number one
   ...
   if (dotE) == (D ** delta):
      print("toy example 1 worked correctly")
   else:
      print("toy example 2 did not work")

   #start toy example number 2
   ...
   if (dotE) == (D ** delta):
      print("toy example 2 worked correctly")
   else:
      print("toy example 2 did not work")

   #start toy example number 3
   ...
   if (dotE) == (D ** delta):
      print("toy example 3 worked correctly")
   else:
      print("toy example 3 did not work")
 
   #start toy example number 4
   ...
   if (leftSide == rightSide):
      print("toy example 4 works correctly")
   else:
      print("toy example 4 did not work")
