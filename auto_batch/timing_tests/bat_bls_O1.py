...
from verifySigs_O1 import verifySigsRecursive_O1
...
def runBLS_Batch_O1(verifyArgsDict, group, verifyFuncArgs, INVALID_SIGNATURE_FRACTION):
	...
	verifySigsRecursive_O1(verifyFuncArgs, verifyArgsDict, dotA, dotB,  verifyArgsDict[0]['pk'][bodyKey]['g^x'],  verifyArgsDict[0]['pk'][bodyKey]['g'], 0, N, group, incorrectSigIndices, N, INVALID_SIGNATURE_FRACTION)
