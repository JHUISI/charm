...
from bat_bls_O1 import runBLS_Batch_O1
...
if __name__ == '__main__':
	...
	for programIteration in range(0, NUM_PROGRAM_ITERATIONS):
		...
		for cycle in range(0, NUM_CYCLES):
			...
			incorrectSigIndices = runBLS_Batch_O1(verifyArgsDictRandomized, groupParamArg, verifyFuncArgs, INVALID_SIGNATURE_FRACTION)
			EndBenchmark(bID1)
