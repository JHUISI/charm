...
def buildSchemesDetails():
	...
	schemesDetails["HESS"]["batcher"] = ["batchverify.py", "../tests/hess.bv", "-p"]
	...
	schemesDetails["CHCH"]["batcher"] = ["batchverify.py", "../tests/chch.bv", "-p"]
	...
	schemesDetails["WATERS"]["batcher"] = ["batchverify.py", "../tests/waters.bv", "-p"]

	# Cyh
	schemesDetails["CYH"]["codegen"] = ["CYH/pksig_cyh.py", "CYH/batchOutputCYH", "garbageValue", "tmp/cyhIND.py", "tmp/cyhBAT.py", "tmp/cyhIND.py"] 
	schemesDetails["CYH"]["batcher"] = ["batchverify.py", "../tests/cyh.bv", "-p"]
	...
	schemesDetails["Boyen"]["batcher"] = ["batchverify.py", "../tests/boyen.bv", "-p"]
	...
	schemesDetails["BBS"]["batcher"] = ["batchverify.py", "../tests/bbs.bv", "-p"]
	...
	schemesDetails["HW_Different"]["batcher"] = ["batchverify.py", "../tests/hw-diff.bv", "-p"]
