...
def mainFunctionForTimings(sysArg1, sysArg2, sysArg3, sysArg4, sysArg5, sysArg6):

	try:
		pythonCodeArg = sysArg1
		batchVerifierOutputFile = sysArg2
		verifyParamFilesArg = sysArg3
		individualVerArg = sysArg4
		batchVerArg = sysArg5
		verifySigsArg = sysArg6
	except:
...
if __name__ == '__main__':
	...
	mainFunctionForTimings(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6])
