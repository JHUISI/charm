...
def verifySigsRecursive(verifyArgsDict, groupObj, incorrectIndices, startSigNum, endSigNum, n, S, delta, dotA, dotB, dotC, dotD, dotE, dotF, dotG):
	z = 0
	...
	if (  pair( dotA_loopVal , verifyArgsDict[z]['pk'][bodyKey] [ 'g2' ] )==( dotB_loopVal *( dotC_loopVal *( dotD_loopVal *( pair( dotE_loopVal , verifyArgsDict[z]['pk'][bodyKey] [ 'w2' ] ) *( pair( dotF_loopVal , verifyArgsDict[z]['pk'][bodyKey] [ 'z2' ] ) * pair( dotG_loopVal , verifyArgsDict[z]['pk'][bodyKey] [ 'h2' ] ) ) ) ) ) )  ):
		pass
	else:
		...
		verifySigsRecursive(verifyArgsDict, group, incorrectIndices, startSigNum, midSigNum, n, S, delta, dotA, dotB, dotC, dotD, dotE, dotF, dotG)
		verifySigsRecursive(verifyArgsDict, group, incorrectIndices, midSigNum, endSigNum, n, S, delta, dotA, dotB, dotC, dotD, dotE, dotF, dotG)
		return
