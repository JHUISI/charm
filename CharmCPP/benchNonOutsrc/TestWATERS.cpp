...
void Waters09::keygen(CharmList & pk, CharmList & msk, CharmListStr & S, CharmList & sk)
{
    G1 g1;
    G2 g2;
    GT egg;
...
void Waters09::decrypt(CharmList & pk, CharmList & sk, CharmListStr & S, CharmList & ct, GT & M)
{
    string policy_str;
    GT C;
    G1 Cpr;
