from HVE_LATESTLATER_USER import *
...
def transform(CT, skBlinded):
    ...
    output = (transformOutputList, nn, YVectorBlinded, LVectorBlinded)
    return output

def decout(transformOutputList, bf0, nn, YVectorBlinded, LVectorBlinded):
