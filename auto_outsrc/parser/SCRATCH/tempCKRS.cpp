...
void extract(CharmList & mpk, CharmList & msk, string & id, ZR & blindingFactord0Blinded, ZR & blindingFactord1Blinded, ZR & blindingFactord2Blinded, ZR & blindingFactor0Blinded, ZR & blindingFactor1Blinded, ZR & blindingFactord5Blinded, CharmList & skBlinded)
{
    string idBlinded;
    ...
    blindingFactord5Blinded = group.random(ZR_t);
    idBlinded = id;
    ...
    d5 = group.exp(g, group.mul(t1, t2));
    d5Blinded = group.exp(d5, group.div(1, blindingFactord5Blinded));
...
void transform(CharmList & sk, CharmList & ct, CharmList & transformOutputList)
{
    ...
    c4 = ct[4].getG1();
    cpr = ct[5].getGT();
    transformOutputList.insert(0, group.pair(d5, d0));
...
void decout(CharmList & sk, CharmList & ct, CharmList & transformOutputList, ZR & blindingFactord0Blinded, ZR & blindingFactord1Blinded, ZR & blindingFactord2Blinded, ZR & blindingFactor0Blinded, ZR & blindingFactor1Blinded, ZR & blindingFactord5Blinded, GT & M)
{
    string id;
    G2 d0;
    G2 d1;
