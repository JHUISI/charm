#include "userFuncs_LW.h"

string decout(PairingGroup & group, CharmDict & partCT, ZR & blindingFactor_deleteMeVarBlinded, ZR & blindingFactor_KBlinded, GT & egg)
{
    GT T0;
    string T1;
    GT T2;
...
int main(int argc, char* argv[])
{
    ...
    parsePartCT("partCT_LW_.txt", dict);
    parseKeys("keys_LW_.txt", zz, pk);
